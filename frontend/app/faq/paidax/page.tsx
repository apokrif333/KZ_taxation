...
const steps = [
  {
    title: 'Откройте раздел отчётов в Paidax',
    text: 'Войдите в приложение Paidax и откройте меню слева вверху. Выберите «Неторговое поручение». В некоторых версиях приложения этот раздел открывается через «Ещё» → «Декларирование ценных бумаг».',
    image: '/faq/paidax/step-1-menu.png',
    alt: 'Раздел «Декларирование ценных бумаг» в приложении Paidax',
  },
  {
    title: 'Выберите «Брокерский отчёт»',
    text: 'В разделе декларации выберите пункт «Брокерский отчёт».',
  ...
  },
  {
    ...
    text: 'В блоке «Данные для форм 240.00, 250.00, 270.00» выберите нужный год и нажмите «Получить отчёт Excel». Укажите период с 1 января по 31 декабря и повторите загрузку для каждого года существования счёта.',
    image: '/faq/paidax/step-3-download-excel.png',
    alt: 'Выбор года и кнопка «Получить отчёт Excel» в Paidax',
  },
  {
