    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mt-10" aria-labelledby="check-data-title">
          ...
          <Card className="mt-4 border-border/80"><CardContent className="pt-6"><ol className="list-decimal space-y-3 pl-5 text-sm leading-relaxed text-muted-foreground"><li>Откройте <a href="https://knp.kgd.gov.kz" target="_blank" rel="noreferrer" className="font-medium text-primary underline-offset-4 hover:underline">Кабинет налогоплательщика КГД <ExternalLink className="inline-block size-3.5" aria-hidden="true" /></a> и выберите <strong className="text-foreground">«Подать документ»</strong>.</li><li>Найдите форму 270.00 «Декларация о доходах и имуществе физического лица». Если формы нет в списке, возможно, в кабинете указан статус ИП — уточните его через 1414.</li><li>Выберите налоговый год, нажмите <strong className="text-foreground">«Подать»</strong>, затем <strong className="text-foreground">«Предзаполнить декларацию»</strong>.</li><li>Пролистайте форму до конца, но пока не отправляйте её. Запишите поля, которые КГД уже заполнил: доходы, активы, имущество, операции или задолженности. Их нужно будет дополнить после загрузки JSON.</li></ol></CardContent></Card>
        ...
        <section className="mt-12" aria-labelledby="upload-title">
          ...
          <div className="mt-4 grid gap-4">
            <Card className="border-border/80"><CardHeader><CardTitle className="text-lg">Загрузите файл</CardTitle><CardDescription className="leading-relaxed">Вернитесь в КНП: «Подать документ» → форма 270.00 → выберите налоговый год → «Загрузить (JSON)». Выберите JSON-файл, который сформировал сервис.</CardDescription></CardHeader><CardContent><GuideImage src="/faq/form270-upload/step-2-prepopulate.png" alt="Окно формы 270.00 с выбором года и кнопкой загрузки JSON" caption="Выберите год и нажмите «Загрузить (JSON)»." /></CardContent></Card>
            ...
            <Card className="border-primary/20 bg-accent/20"><CardContent className="flex flex-col gap-4 pt-5 sm:flex-row sm:items-start"><Send className="mt-0.5 size-5 shrink-0 text-primary" aria-hidden="true" /><div className="text-sm leading-relaxed text-muted-foreground"><p>После отправки проверьте, что декларация появилась в разделе «Мои документы» и имеет статус принятой.</p><div className="mt-4"><GuideImage src="/faq/form270-upload/step-7-submitted.png" alt="Раздел «Мои документы» КНП с принятыми декларациями 270.00" caption="Пример принятой декларации в личном кабинете КГД." /></div></div></CardContent></Card>
          </div>
        </section>
