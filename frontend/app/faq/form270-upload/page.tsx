    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mt-10" aria-labelledby="check-data-title">
          ...
          <Card className="mt-4 border-border/80"><CardContent className="pt-6"><ol className="list-decimal space-y-3 pl-5 text-sm leading-relaxed text-muted-foreground"><li>Откройте <a href="https://knp.kgd.gov.kz" target="_blank" rel="noreferrer" className="font-medium text-primary underline-offset-4 hover:underline">Кабинет налогоплательщика КГД <ExternalLink className="inline-block size-3.5" aria-hidden="true" /></a> и выберите <strong className="text-foreground">«Подать документ»</strong>.<div className="mt-4"><GuideImage src="/faq/form270-upload/step-7-submitted.png" alt="Раздел «Мои документы» КНП с принятыми декларациями 270.00" caption="Раздел «Мои документы» в кабинете КГД." /></div></li><li>Найдите форму 270.00 «Декларация о доходах и имуществе физического лица». Если формы нет в списке, возможно, в кабинете указан статус ИП — уточните его через 1414.</li><li>Выберите налоговый год, нажмите <strong className="text-foreground">«Подать»</strong>, затем <strong className="text-foreground">«Предзаполнить декларацию»</strong>.<div className="mt-4"><GuideImage src="/faq/form270-upload/step-2-prepopulate.png" alt="Окно формы 270.00 с выбором года и кнопкой загрузки JSON" caption="Выберите год и нажмите «Подать» или «Предзаполнить декларацию»." /></div></li><li>Пролистайте форму до конца, но пока не отправляйте её. Запишите поля, которые КГД уже заполнил: доходы, активы, имущество, операции или задолженности. Их нужно будет дополнить после загрузки JSON.</li></ol></CardContent></Card>
