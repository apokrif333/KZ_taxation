...
# ISIN uses ISO 3166-1 alpha-2 prefixes, while the Form 270 dictionary uses
# alpha-3 values. Keep the conversion complete rather than limiting it to the
# countries that happened to occur in early broker exports. A few target
# values intentionally follow the Form 270 dictionary's legacy vocabulary:
# CD -> ZAR, MM -> BUR and TL -> TMP.
_ISO2_TO_FORM270_ISO3_PAIRS = """
...
BV:BVT BW:BWA BY:BLR BZ:BLZ CA:CAN CC:CCK CD:ZAR CF:CAF CG:COG CH:CHE CI:CIV
...
MK:MKD ML:MLI MM:BUR MN:MNG MO:MAC MP:MNP MQ:MTQ MR:MRT MS:MSR MT:MLT MU:MUS
...
TL:TMP TM:TKM TN:TUN TO:TON TR:TUR TT:TTO TV:TUV TW:TWN TZ:TZA UA:UKR UG:UGA
...
COUNTRY_ISO3_BY_ISO2 = {
    **{
        ...
        for pair in _ISO2_TO_FORM270_ISO3_PAIRS.split()
    },
    # Historic ISIN prefix retained because the form dictionary includes it.
    "AN": "ANT",
    # Common country names from broker and configuration data.
    "CYPRUS": "CYP",
    "KAZAKHSTAN": "KAZ",
    "RUSSIA": "RUS",
    "UNITED STATES": "USA",
